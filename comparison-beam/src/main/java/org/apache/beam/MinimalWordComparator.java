...
public class MinimalWordComparator {
  ...
  public void test_reading() throws Exception {
    final File file =
            new File(getClass().getResource("files/credit_train_data.csv").toURI());
    ...
    final PCollection<String> output =
           ...
           pipeline.apply(TextIO.write().to("output"));
  ...
  public static void main(String[] args) {
    ...
    // PCollection<String> data1 = p.apply(TextIO.read().from("files/credit_train_data.csv"))
    ...
    MinimalWordComparator obj = new MinimalWordComparator();
